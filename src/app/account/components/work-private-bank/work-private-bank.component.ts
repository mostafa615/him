...
@Component({
  selector: 'app-work-private-bank',
  templateUrl: './work-private-bank.component.html',
  styleUrls: ['./work-private-bank.component.scss']
})
export class WorkPrivateBankComponent implements OnInit {
